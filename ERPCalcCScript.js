 ...
 */
define(['N/record', 'N/recordContext', 'N/runtime'],
/**
 * @param{record} record
 ...
 */
function(record, recordContext, runtime, ) {
    ...
    function saveRecord(scriptContext) {
        ...
        try{
            ...
            var fullfilled = record.getValue({
                fieldId: 'custrecord_lf_fulfilled_erp'
            })

            var futureShip = record.getValue({
                fieldId: 'custrecord_lf_futureship_erp'
            })

            var productionHours = record.getValue({
                fieldId: 'custrecord_lf_production_hours_erp'
            })

            var results = (fullfilled + futureShip) / productionHours
            var answer;
